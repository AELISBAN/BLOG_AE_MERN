      ...
      <section className="bg-light">
        <div className="container d-flex flex-column align-items-center justify-content-center min-vh-100 py-4">
          <a href="#" className="mb-4 text-dark text-decoration-none d-flex align-items-center">
            ...
            <Link to={'/'}> <span className="h4 mb-0 fw-bold">Blog AE</span></Link> 
          </a>
          <div className="card shadow-sm w-100" style={{ maxWidth: '400px' }}>
            <div className="card-body p-4">
              <h1 className="h5  fw-bold text-dark">Crear una cuenta</h1>
              <form onSubmit={handleSubmit}>
                <div className=" text-center">
                  <label htmlFor="image" className="form-label">Foto de perfi</label>
                ...
                <div className="mb-3">
                  <label htmlFor="fullName" className="form-label">Nombres</label>
                  <input 
                    type="text" 
