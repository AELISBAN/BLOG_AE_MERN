    ...
    <div className="container text-white mt-5 mb-5">
      <div className="row">
        <div className="col-md-12">
          ...
          <h3 className="mt-5 mb-4">Deja un comentario</h3>
          <form>
            <div className="mb-3">
              <label htmlFor="comment" className="form-label">Comentario</label>
              <textarea className="form-control" id="comment" rows="4" placeholder="Escribe tu comentario aqui." required
               value={ comment} onChange={(e)=>setComment(e.target.value)}></textarea>
            </div>
            <button type="submit" className="btn btn-primary" onClick={onSubmitComment}>Enviar comentario</button>
          </form>

          <hr />

          <h3 className="mt-5 mb-4">Comentarios</h3>
