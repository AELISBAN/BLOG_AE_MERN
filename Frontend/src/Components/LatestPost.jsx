        ...
        <>
            <div className="container">
                <div className='mb-5 text-center'>
                    <h2 className="fw-bold fs-1 text-white">Publicaciónes recientes</h2>
                </div>
                <div className="row">
                            ...
                            <div className="col-md-4 mb-4" key={elem._id}>
                                <div className="card border-success" style={{ borderWidth: "2px", backgroundColor: "#2b2b2b", borderRadius: "10px", overflow: "hidden" }}>
                                    ...
                                    <div className="card-body bg-dark text-white">
                                        ...
                                        <button className="btn btn-primary w-100 mt-3" onClick={() => handleBlog(elem._id)}>Leer Articulo AE</button>
                                    </div>
                                </div>
                            </div>
                        );
